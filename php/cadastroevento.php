...
<div class="container mt-5  font-weight-bold">
	...
	<div class="form-row mb-4">
		...
		<label class="form-check-label mr-3 " for="modalidade"><input type="radio" class="mr-2 align-middle" name="modalidade" id="presencial" value="presencial" onclick="pre()">Presencial</label>

		<label class="form-check-label mr-3 " for="modalidade"><input type="radio" class="mr-2 align-middle" name="modalidade" id="online" value="online" onclick="on()">Online</label>
			
		<label class="form-check-label mr-3 " for="modalidade"><input type="radio" class="mr-2 align-middle" name="modalidade" id="semipresencial" value="semipresencial" onclick="semi()"> Semipresencial</label>
	</div>
